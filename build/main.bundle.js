...
document.querySelector('#btn-1').addEventListener('click', menuBtn);
...
document.querySelector('#todo-1').addEventListener('click', todoBtn);
// Add Event to the weatherBtn
document.querySelector('#weather-1').addEventListener('click', weatherBtn);
...
var UI = function () {
  function UI() {
    ...
    this.todo = document.querySelector('#maa');
    this.weather = document.querySelector('#weather-lay');
  }
